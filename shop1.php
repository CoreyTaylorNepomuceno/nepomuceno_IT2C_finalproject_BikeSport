                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        ...
                                        <h4><a href="shop.html"><?php 
                                            ...
                                            <p>
                                                Giant road bikes for men are your invitation to ride. Whether you're digging deep for a new PR, commuting in the city, or on a casual cruise, make the most of every ride with one of our men's road bikes.
                                            </p>
                                            <span class="p-mask">
                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        ...
                                        <h4><a href="shop.html"><?php 
                                            ...
                                            <p>
                                                The S-Works bikes use a different carbon lay-up. The S-Works frames are lighter and stiffer. Also they come with ceramicspeed BB as standard.
                                            </p>
                                            <span class="p-mask">
                                                <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                                                <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        ...
                                        <h4><a href="shop.html"><?php 
                                            ...
                                            <p>
                                                Specialized road bikes have been awarded five-star reviews from our tech team, and the brand regularly features in our guides, such as the best road bikes, best gravel bikes, and best aero road bikes.
                                            </p>
                                            <span class="p-mask">
                                                <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                                                <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        ...
                                        <h4><a href="shop.html"><?php 
                                            ...
                                            <p>
                                                Trek fitness bikes are designed to provide speed that rivals many road bikes, with more predictable handling.
                                            </p>
                                            <span class="p-mask">
                                                <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                                                <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        ...
                                        <h4><a href="shop.html"><?php 
                                            ...
                                            <p>
                                                An absolute mile-muncher thanks to a great combination of comfort and speed.
                                            </p>
                                            <span class="p-mask">
                                                <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                                                <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
