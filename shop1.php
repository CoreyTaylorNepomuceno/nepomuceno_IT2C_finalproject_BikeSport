                        ...
                        <div class="tz-product row grid-eff">
                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="images/product/RoadBike1.png" alt="Giant Road Bike">
                                        </div>
                                        ...
                                        <h4><a href="shop.html"><?php 
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Giant road bikes for men are your invitation to ride. Whether you are digging deep for a new PR, commuting in the city, or on a casual cruise, make the most of every ride with one of our mens road bikes.';
                                            echo '</p>';
                            ...
                            <div class="product-item col-md-4 col-sm-6">
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="images/product/RoadBike2.png" alt="S-Works Road Bike">
                                        </div>
                                        <div class="product-info">
                                        <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'The S-Works bikes use a different carbon lay-up. The S-Works frames are lighter and stiffer. Also they come with ceramicspeed BB as standard.';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                            ...
                            <div class="product-item col-md-4 col-sm-6">
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="images/product/Roadbike3.png" alt="Specialized Road Bike">
                                        </div>
                                        <div class="product-info">
                                        <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Specialized road bikes have been awarded five-star reviews from our tech team, and the brand regularly features in our guides, such as the best road bikes, best gravel bikes, and best aero road bikes.';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                            ...
                            <div class="product-item col-md-4 col-sm-6">
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="images/product/RoadBike4.png" alt="Trek Road Bike">
                                        </div>
                                        <div class="product-info">
                                        <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Trek fitness bikes are designed to provide speed that rivals many road bikes, with more predictable handling.';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                            ...
                            <div class="product-item col-md-4 col-sm-6">
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="images/product/RoadBike5.png" alt="Lapiere Road Bike">
                                        </div>
                                        <div class="product-info">
                                        <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'An absolute mile-muncher thanks to a great combination of comfort and speed.';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                            ...
                            <div class="product-item col-md-4 col-sm-6">
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="images/product/RoadBike6.png" alt="Jay Jo's Fixie Bike">
                                        </div>
                                        <div class="product-info">
                                        <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Fixed-gear bikes make great winter bikes, but they are also excellent urban rides, provided you do not have to tackle any long, steep hills.';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
