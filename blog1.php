                            ...
                            <div class="row tz-blog-content">
                                <div class="col-md-12">
                                    <article class="blog-item blog-heading">
                                        <div class="thumb">
                                            <img src="images/Blog/bbm.png" alt="peace">
                                        </div>
                                        <div class="blog-info">
                                        <?php
                                            echo '<h3><a href="single-blog.html">Tour de Hongrie: Jakobsen gets two in a row with stage 3 victory</a></h3>';
                                            echo '<span class="entry-meta">By Reynan Yap published about 15 hours ago</span>';
                                            echo '<p>';
                                            echo 'Fabio Jakobsen (QuickStep-AlphaVinyl) hit out along the right side barriers and won stage 3 of the Tour de Hongrie';
                                            echo 'in a frenzied, fast finish at Kossuth Square. Rudy Barbier (Israel-Premier Tech) finished second and Sasha Weemaes';
                                            echo '(S;port Vlaanderen-Baloise) third on the wet roads at the end of the 154km stage. Jakobsen took over the GC lead from';
                                            echo 'Jens Reynders (Sport Vlaanderen-Baloise), who now trails the QuickStep sprinter by six seconds. Barbier is third overall,';
                                            echo 'another two seconds back, and takes over as the points classification leader.';
                                            echo '</p>';
