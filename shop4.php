                        ...
                        <div class="tz-product row grid-eff">
                                    ...
                                    <div class="item">
                                        <div class="product-item-inner">
                                            <div class="product-thumb">
                                                <img src="images/product/kid.png" alt="wheel1">
                                            </div>
                                ...
                                <div class="product-item col-md-4 col-sm-6">
                                    <div class="item">
                                        <div class="product-item-inner">
                                            <div class="product-thumb">
                                                <img src="images/product/kid2.png" alt="basket">
                                            </div>
                                            <div class="product-info">
                                            <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Very Comfortable and fun with a basket';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                                ...
                                <div class="product-item col-md-4 col-sm-6">
                                    <div class="item">
                                        <div class="product-item-inner">
                                            <div class="product-thumb">
                                                <img src="images/product/kid3.png" alt="paw patrol">
                                            </div>
                                            <div class="product-info">
                                            <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Very Comfortable and fun but it is Paw Patrol';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                                ...
                                <div class="product-item col-md-4 col-sm-6">
                                    <div class="item">
                                        <div class="product-item-inner">
                                            <div class="product-thumb">
                                                <img src="images/product/kid4.png" alt="racer">
                                            </div>
                                            <div class="product-info">
                                            <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Very Comfortable and fun but faster';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                                ...
                                <div class="product-item col-md-4 col-sm-6">
                                    <div class="item">
                                        <div class="product-item-inner">
                                            <div class="product-thumb">
                                                <img src="images/product/kid5.png" alt="police">
                                            </div>
                                            <div class="product-info">
                                            <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Very Comfortable and fun but you got the law to back you up';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
                                ...
                                <div class="product-item col-md-4 col-sm-6">
                                    <div class="item">
                                        <div class="product-item-inner">
                                            <div class="product-thumb">
                                                <img src="images/product/kid6.png" alt="carbon">
                                            </div>
                                            <div class="product-info">
                                            <h4><a href="shop.html"><?php 
                                            $item = simplexml_load_file('nepomuceno_IT2C_BikeSport.xml');
                                            ...
                                            echo '</span>';
                                            echo '<p>';
                                            echo 'Very Comfortable and fun but it is carbon #CarbonLodi';
                                            echo '</p>';
                                            echo '<span class="p-mask">';
                                            echo '<a href="shop-cart.html" class="add-to-cart">Add to cart</a>';
                                            echo '<a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>';
