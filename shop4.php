        ...
        <div class="product-item-inner">
            ...
            <h4><a href="shop.html"><?php 
                ...
                <span class="p-color">
                    ...
                    <p>
                        Very Comfortable and fun with a basket
                    </p>
                <span class="p-mask">
                    <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                    <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
        ...
        <div class="product-item-inner">
            ...
            <h4><a href="shop.html"><?php 
                ...
                <span class="p-color">
                    ...
                    <p>
                        Very Comfortable and fun but it is Paw Patrol
                    </p>
                <span class="p-mask">
                    <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                    <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
        ...
        <div class="product-item-inner">
            ...
            <h4><a href="shop.html"><?php 
                ...
                <span class="p-color">
                    ...
                    <p>
                        Very Comfortable and fun but faster
                    </p>
                <span class="p-mask">
                    <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                    <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
        ...
        <div class="product-item-inner">
            ...
            <h4><a href="shop.html"><?php 
                ...
                <span class="p-color">
                    ...
                    <p>
                        Very Comfortable and fun but you got the law to back you up
                    </p>
                <span class="p-mask">
                    <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                    <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
        ...
        <div class="product-item-inner">
            ...
            <h4><a href="shop.html"><?php 
                ...
                <span class="p-color">
                    ...
                    <p>
                        Very Comfortable and fun but it is carbon #CarbonLodi
                    </p>
                <span class="p-mask">
                    <a href="shop-cart.html" class="add-to-cart">Add to cart</a>
                    <a href="#" class="add-to-wishlist"><i class="fa fa-heart"></i> Add to wishlist</a>
