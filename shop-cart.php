                    ...
                    <tbody>
                        ...
                        <tr class="cart_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="single-product.html"><img src="images/product/shorts.png" alt="cart" /></a>
                            </td>
                        ...
                        <tr class="cart_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="single-product.html"><img src="images/product/shimanocleats.png" alt="cart" /></a>
                            </td>

                            <td class="product-name">
                                <a href="single-product.html">Shimano Cleats Pedal </a>
                                <span class="color">
                        ...
                        <tr>
                            <td class="actions" colspan="6">
                                <a class="back-shop" href="shop.html"><i class="fa fa-angle-left"></i> BACK TO SHOP</a>
