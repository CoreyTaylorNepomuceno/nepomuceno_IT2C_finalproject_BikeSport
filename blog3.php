                            ...
                            <div class="row tz-blog-content">
                                <div class="col-md-12">
                                    <article class="blog-item blog-heading">
                                        <div class="thumb">
                                            <img src="images/Blog/riders.png" alt="riders">
                                        </div>
                                        <div class="blog-info">
                                            <h3><a href="single-blog.html">No rewards for Team DSM as Lippert loses time in Itzulia Women opener</a></h3>
                                            <span class="entry-meta">By Ashley Saludo published about 18 hours ago</span>
                                            <p>
                                                Team DSM were one of the teams with four riders in the first group when the 
                                                peloton split on the two climbs in the middle of stage 1 of the Itzulia Women stage race.However, 
                                                the Dutch team was left chasing breakaways in the final as it missed the decisive moves, and in the end, 
                                                team leader Liane Lippert lost valuable time in the general classification. 
                                            </p>
